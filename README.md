...
## Activity
### WordPress CMS
- **Abilities:** Theme from scratch, child theme, plugin development. Custom product & payments flow. Custom API.
- **Plugins:** ACF, TablePress, CF7, Forminator, WooCommerce, Dokan, Stripe, Klarna, Yoast SEO etc.
- **Builders:** Gutenberg, WPbakery Tool, Elementor, BreakDance, Divi.
### Opencart
- **Abilities:** Themes & modules development from scratch. Custom product flow, processing, etc.
- **Technologies:** Twig, OCmod.
### Laravel
